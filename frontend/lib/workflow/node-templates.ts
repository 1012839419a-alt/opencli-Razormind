...
const NODE_TEMPLATES: NodeTemplate[] = [
  ...
  },
  {
    ...
    title: "网页采集",
    summary: "配置多个网页来源；来源字段在专用列表编辑器中维护。",
    dataShape: "trigger -> CollectorOutputV1",
    fields: [],
  },
  {
    id: "collection.source.api",
    title: "API 采集",
    summary: "配置多个 HTTP API 来源；认证信息只保存凭证引用。",
    dataShape: "trigger -> CollectorOutputV1",
    fields: [],
  },
  {
    ...
    title: "RSS 采集",
    summary: "配置多个 RSS/Atom Feed，并分别控制时间窗口和条目限制。",
    dataShape: "trigger -> CollectorOutputV1",
    fields: [],
  },
  {
    ...
    title: "CLI 采集",
    summary: "仅从已注册 OpenCLI 目录选择工具并填写 typed arguments。",
    dataShape: "trigger -> CollectorOutputV1",
    fields: [],
  },
  {
