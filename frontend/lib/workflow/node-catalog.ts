...
export const WORKFLOW_NODE_CATALOG: WorkflowNodeCatalogItem[] = [
  ...
  },
  {
    ...
    icon: "WandSparkles",
    color: "var(--chart-2)",
    params: { operatorId: "core.generate.instruction-pairs", instructionTemplate: "Use the source material to answer this request: {title}" },
    keywords: ["data", "generate", "instruction", "生成", "数据"],
  },
  {
    id: "intelligence.data.filter",
    idPrefix: "data-filter",
    label: "Filter Data",
    description: "按质量阈值筛选记录候选项",
    category: "processing",
    profile: "intelligence",
    kind: "agent",
    capability: "normalize",
    ...
    keywords: ["data", "filter", "quality", "过滤", "质量"],
  },
  {
    id: "intelligence.data.evaluate",
    idPrefix: "data-evaluate",
    label: "Evaluate Data",
    description: "按质量规则评估记录候选项",
    category: "processing",
    profile: "intelligence",
    kind: "agent",
    capability: "normalize",
    ...
    keywords: ["data", "evaluate", "quality", "评估", "质量"],
  },
  {
    id: "intelligence.data.refine",
    idPrefix: "data-refine",
    label: "Refine Data",
    description: "按指令改进记录候选项",
    category: "processing",
    profile: "intelligence",
    kind: "agent",
    capability: "normalize",
    ...
    params: {
      ...
      fields: ["title", "content", "text", "instruction", "response"],
      unicodeForm: "NFKC",
      redactEmail: false,
      redactPhone: false,
    },
    keywords: ["data", "refine", "text", "改写", "优化"],
  },
  {
