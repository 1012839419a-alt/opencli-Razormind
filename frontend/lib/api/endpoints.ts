...
const workbenchBase = (workspaceId: string) => `/workspaces/${workspaceId}/workbench`
...
export const listWorkbenchRuntimes = (workspaceId: string) =>
  apiClient
    .get<ApiResponse<WorkbenchRuntime[]>>(`${workbenchBase(workspaceId)}/runtimes`)
    .then((r) => r.data.data)

export const listWorkbenchThreads = (workspaceId: string) =>
  apiClient
    .get<ApiResponse<WorkbenchThread[]>>(`${workbenchBase(workspaceId)}/threads`)
    .then((r) => r.data.data)
...
export const cancelWorkbenchTurn = (workspaceId: string, threadId: string, turnId: string) =>
  apiClient
    .post<ApiResponse<WorkbenchTurn>>(
