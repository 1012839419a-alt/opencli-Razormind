...
// Row-level view of the Evidence Ledger. Wrapped by app/(app)/control/layout.tsx
// (PageContainer + CONTROL_TABS) — this page renders only its own content, same
// convention as app/(app)/providers/page.tsx under providers/layout.tsx.
