...
const PALETTE_COPY = {
  "zh-CN": {
    ...
    featuredSites: "A 股数据源",
    catalogIndex: "能力导航",
    featuredDescription: "按行情、公告、新闻、社区与视频浏览可用来源",
  ...
  "en-US": {
    ...
    featuredSites: "A-share data sources",
    catalogIndex: "Capability navigation",
    featuredDescription: "Browse market, filing, news, social, and video sources",
