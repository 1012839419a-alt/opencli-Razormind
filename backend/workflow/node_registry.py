...
WORKFLOW_CATALOG_IDS = {
    ...
    "intelligence.source.channel.opencli",
    "intelligence.source.channel.web_scraper",
    "intelligence.source.channel.api",
    "intelligence.source.channel.rss",
    "intelligence.source.channel.cli",
    "intelligence.source.channel.skill",
    "intelligence.source.channel.crawl4ai",
