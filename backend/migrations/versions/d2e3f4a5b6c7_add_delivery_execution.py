...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("studio_workflow_version_id", sa.String(36), nullable=False),
        sa.Column("run_id", sa.String(36), nullable=False),
        sa.Column("operation_id", sa.String(255), nullable=False),
        sa.Column("decision_hash", sa.String(64), nullable=False),
        sa.Column("payload_hash", sa.String(64), nullable=False),
        sa.Column("execution_binding_hash", sa.String(64), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["decision_id"], ["delivery_authorization_decisions.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["target_revision_id"], ["delivery_target_revisions.id"], ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("decision_id", name="uq_delivery_execution_decision"),
        sa.UniqueConstraint("execution_binding_hash", name="uq_delivery_execution_binding"),
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("transport_classification", sa.String(32), nullable=False),
        sa.Column("http_status", sa.Integer()),
        sa.Column("receipt_classification", sa.String(32), nullable=False),
        sa.Column("protocol_classification", sa.String(32), nullable=False),
        sa.Column("outcome", sa.String(16), nullable=False),
        sa.Column("receipt_id", sa.String(128)),
        sa.Column("receipt_hash", sa.String(64)),
        sa.Column("observed_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["execution_id"], ["delivery_executions.id"], ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "execution_id",
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "operation_id", "decision_hash", name="uq_controlled_receiver_delivery"
        ),
