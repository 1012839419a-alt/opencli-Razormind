...
def run_wechat_article_search_task(
    api_key, keywords, limit=10, publication_date="3月11日"
):
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print(
            "Usage: python wechat_article_search_api.py <keywords> [limit] [publication_date]",
            flush=True,
        )
        sys.exit(1)
