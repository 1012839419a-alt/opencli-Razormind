...
def run_amazon_best_selling_products_finder_task(
    api_key,
    keywords,
    limit=10,
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print(
            "Usage: python amazon_best_selling_products_finder_api.py "
            "<keywords> [limit] [marketplace_url]",
            flush=True,
        )
        sys.exit(1)
    ...
    result = run_amazon_best_selling_products_finder_task(
        api_key,
        keywords,
        limit,
        marketplace_url,
