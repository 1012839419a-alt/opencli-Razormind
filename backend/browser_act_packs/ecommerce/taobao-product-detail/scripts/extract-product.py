...
def main():
    ...
    (function() {{
      try {{
        ...
        var attrs = {{}};
        var emphTitles = Array.from(document.querySelectorAll(
          '[class*="emphasisParamsInfoItemTitle--"]'));
        var emphSubs = Array.from(document.querySelectorAll(
        ...
        var genTitles = Array.from(document.querySelectorAll(
          '[class*="generalParamsInfoItemTitle--"]'));
        var genSubs = Array.from(document.querySelectorAll(
